  ...
  // éléments repris du fichier HTML

  let citationPlace = document.querySelector('#citation');
...
let citations = [
  ...
  // Modification de la citation en cliquant le bouton

  bouton.addEventListener('click', ()=>{
    do { nombreAleatoire = genererNombreEntier(citations.length);
      
    } while (nombreAleatoire == index)

   citationPlace.textContent = citations[nombreAleatoire][0];
